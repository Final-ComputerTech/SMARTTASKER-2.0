-- ============================================================
-- SMARTTASKER 2.0 — DATABASE + SEED DATA FULL
-- File: database_full_seed.sql
-- Author: Hoàng Cẩm Anh
-- Purpose: Tạo database + seed dữ liệu mẫu cho backend
-- ============================================================

-- ===============================
-- 0. CREATE DATABASE
-- ===============================
DROP DATABASE IF EXISTS smarttasker_2_0;
...
-- ===============================
-- 10. COLLABORATOR + TASK-COLLABORATOR
-- ===============================
